...
class absenteeism_model():
        ...
        def __init__(self, model_file, scaler_file):
            ...
            with open(model_file, 'rb') as model_file_obj, open(scaler_file, 'rb') as scaler_file_obj:
                self.reg = pickle.load(model_file_obj)
                self.scaler = pickle.load(scaler_file_obj)
                self.data = None
